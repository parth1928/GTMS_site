...
const SponsorshipForm = () => {
  return (
    <div id="contact" className="w-full py-20 bg-black text-white">
      <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          <div className="flex justify-between items-start gap-4 flex-wrap">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600/10 border border-orange-500 text-orange-500 hover:bg-orange-600 hover:text-white transition-all duration-300 rounded-lg font-outfit"
            >
          ...
          <div className="space-y-6 text-gray-300 font-outfit">
            <p>
          ...
          <ul className="space-y-4">
            {whySponsorPoints.map((point) => (
              <li key={point} className="flex items-center">
                <CheckCircle2 className="w-6 h-6 mr-3 text-orange-500" />
          ...
          <p className="text-lg font-orbitron text-orange-500">
        ...
        <div className="p-8 rounded-lg bg-gray-900/50 border border-gray-800">
          ...
          >
            ...
            <h3 className="text-2xl font-bold font-orbitron">Sponsorship Inquiry</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                <Label htmlFor="name">Name</Label>
                <Input name="name" id="name" placeholder="Raj Patel" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="company">Company / Organization</Label>
                <Input name="company" id="company" placeholder="TechMahindra Ltd." required />
              </div>
            </div>
            <div className="space-y-2">
              <Label htmlFor="email">Email</Label>
              <Input name="email" id="email" type="email" placeholder="raj.patel@techmahindra.com" required />
            </div>
            <div className="space-y-2">
              <Label htmlFor="phone">Phone (Optional)</Label>
              <Input name="phone" id="phone" type="tel" placeholder="+91 98765 43210" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="message">Message / Query</Label>
              <Textarea name="message" id="message" placeholder="I represent TechMahindra and would like to explore partnership opportunities with GTU Motorsports..." required />
            </div>
            <motion.button
              type="submit"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 font-bold text-white uppercase transition-all duration-300 bg-orange-600 rounded-none hover:bg-orange-500 hover:shadow-[0_0_20px_rgba(234,88,12,0.5)]"
            >
              Send Inquiry
            </motion.button>
          </form>
